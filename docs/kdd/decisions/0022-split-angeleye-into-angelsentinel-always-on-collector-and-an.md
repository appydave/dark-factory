---
id: ADR-0022
title: "Split AngelEye into AngelSentinel (always-on collector) and AngelEye Control Plane (dashboard)"
status: proposed
scope: internal
...
provenance:
  sessions: ["8fcd0c4f"]
  files: ["experiments/watchtower-engine/queue/q-20260608-angelsentinel-spec.json", "experiments/watchtower-engine/runs/run-angelsentinel-001.json", "~/dev/ad/apps/angeleye/docs/requirements/angelsentinel-split-spec-2026-06-08.md"]
  commits: []
tags: []
---
