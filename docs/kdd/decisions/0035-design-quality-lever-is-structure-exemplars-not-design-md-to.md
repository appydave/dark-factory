---
id: ADR-0035
title: "Design-quality lever is structure + exemplars, not DESIGN.md token expansion"
status: proposed
scope: internal
...
provenance:
  sessions: ["f2df9480"]
  files: ["docs/david-design-patterns.md", "tools/mocha-census/extract.py", "tools/mocha-census/out/ratings/exemplars.json"]
  commits: []
tags: []
---
