---
id: ADR-0005
title: "Handover documents are written to backlog/ in the repo, not to ~/.claude/sessions/, despite the capture-context skill's own staleness warning"
status: proposed
scope: internal
...
provenance:
  sessions: ["215b9cee"]
  files: ["backlog/2026-06-08-session-handover.md", "backlog/2026-06-08-session2-correction-handover.md"]
  commits: []
tags: []
---
