---
id: ADR-0012
title: "Harness promotion decided per-mechanism (evaluation before promotion), not as a wholesale 'promote suborch's kernel'"
status: proposed
scope: internal
...
provenance:
  sessions: ["2fdc2412"]
  files: ["apps/dark-factory/docs/harness-evaluation.md", "apps/dark-factory/engine/consumer.py", "apps/dark-factory/engine/orchestrator.py", "apps/dark-factory/engine/warm_pool.py"]
  commits: ["1cbbf2b", "96fe799", "cb998d4"]
tags: []
---
