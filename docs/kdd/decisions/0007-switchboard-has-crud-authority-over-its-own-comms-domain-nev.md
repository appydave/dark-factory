---
id: ADR-0007
title: "Switchboard has CRUD authority over its own comms domain; 'never kill' applies only to the externally observed system"
status: proposed
scope: internal
...
provenance:
  sessions: ["2df0e613"]
  files: ["backlog/specs/df7-switchboard-state-plane-spec.md"]
  commits: []
tags: []
---
