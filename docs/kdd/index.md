...
2 patterns · 45 learnings · 43 decisions
...
- [Decisions](decisions/index.md) — 43 proposed ADR candidates, numbered ADR-0001 onward (fresh
...
Two near-duplicate pairs were kept as separate entries (safe-bias: surface, don't silently merge)
and are worth a human merge pass — see `_runs/2026-07-04-david-roamy/RECONCILE-TRIAGE.md`:
decisions [0006](decisions/0006-move-dark-factory-job-state-off-flat-files-into-a-switchboar.md)/[0023](decisions/0023-move-job-work-state-off-flat-files-onto-a-service-backed-sha.md)
(both "move job-state to Switchboard," different sessions) and
[0036](decisions/0036-consolidate-comprehend-visualise-into-mochaccino-as-a-4th-mo.md)/[0040](decisions/0040-consolidate-the-comprehend-render-front-end-into-the-design-.md)
(a comprehend-visualise consolidation proposal + its later execution).
